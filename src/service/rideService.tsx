...
export const createRide = async (payload: {
  ...
  try {
    ...
    Alert.alert("Oh! Dang 4there was an error");
...
export const getMyRides = async (isCustomer: boolean = true) => {
  try {
    ...
    Alert.alert("Oh! Dang5 there was an error");
...
export const acceptRideOffer = async (rideId: string) => {
  try {
    ...
    Alert.alert("Oh! Dang6 there was an error");
    console.log(error);
  }
};
...
export const updateRideStatus = async (rideId: string, status: string) => {
  try {
    ...
    Alert.alert("Oh! Dang7 there was an error");
    console.log(error);
    return false;
  }
};
